...
graphs = [
    ...
    ("test/rwd_metrics/gaussian_vel_x", None, "std"),
    ("test/rwd_metrics/gaussian_vel_y", None, "std"),
    ...
    ("test/rwd_metrics/gaussian_vel_x", "test/episode_length/mean", None),
    ("test/rwd_metrics/gaussian_vel_y", "test/episode_length/mean", None),
